-- BROKER_RANK_OMTDBT_QTR manual intervention on new year

select * from dibots_v2.broker_rank_omtdbt_qtr where year = 2022 and qtr = 1;
...
where a.year_qtr = b.year_qtr and a.participant_code = b.participant_code and a.year >= 2022 and a.qtr >= 1;

select * from dibots_v2.broker_rank_omtdbt_qtr_totals order by year_qtr desc;
...
where a.year = b.year and a.qtr = b.qtr and a.year >= 2022 and a.qtr >= 1;
...
from dibots_v2.broker_rank_omtdbt_qtr
where total_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where local_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where foreign_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where inst_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where local_inst_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where foreign_inst_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where retail_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where local_retail_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where foreign_retail_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where nominees_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where local_nominees_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where foreign_nominees_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where prop_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where ivt_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where pdt_val <> 0 and year >= 2022 and qtr >= 1
...
from dibots_v2.broker_rank_omtdbt_qtr
where buy_vol <> 0 and year >= 2022 and qtr >= 1
group by year, qtr, participant_code) tmp
where a.year = tmp.year and a.qtr = tmp.qtr and a.participant_code = tmp.participant_code;
...
from dibots_v2.broker_rank_omtdbt_qtr
where buy_val <> 0 and year >= 2022 and qtr >= 1
group by year, qtr, participant_code) tmp
where a.year = tmp.year and a.qtr = tmp.qtr and a.participant_code = tmp.participant_code;
...
from dibots_v2.broker_rank_omtdbt_qtr
where sell_vol <> 0 and year >= 2022 and qtr >= 1
group by year, qtr, participant_code) tmp
where a.year = tmp.year and a.qtr = tmp.qtr and a.participant_code = tmp.participant_code;
...
from dibots_v2.broker_rank_omtdbt_qtr
where sell_val <> 0 and year >= 2022 and qtr >= 1
group by year, qtr, participant_code) tmp
where a.year = tmp.year and a.qtr = tmp.qtr and a.participant_code = tmp.participant_code;
